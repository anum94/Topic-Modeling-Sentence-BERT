...
class model(nn.Module):
    ...
    def __init__(self, latent_dim, input_dim):
        ...
        self.enc2 = nn.Linear(in_features=int(input_dim*0.8), out_features=int(input_dim*0.6))
        self.norm2 = nn.LayerNorm(int(input_dim*0.6))
        self.enc3 = nn.Linear(in_features=int(input_dim*0.6), out_features=int(input_dim*0.4))
        self.norm3 = nn.LayerNorm(int(input_dim*0.4))
        self.enc4 = nn.Linear(in_features=int(input_dim*0.4), out_features=int(input_dim*0.2))
        ...
        self.dec2 = nn.Linear(in_features=int(input_dim*0.2), out_features=int(input_dim*0.4))
        self.norm7 = nn.LayerNorm(int(input_dim*0.4))
        self.dec3 = nn.Linear(in_features=int(input_dim*0.4), out_features=int(input_dim*0.6))
        self.norm8 = nn.LayerNorm(int(input_dim*0.6))
        self.dec4 = nn.Linear(in_features=int(input_dim*0.6), out_features=int(input_dim*0.8))
